...
public class DeploymentHelper extends AbstractDeploymentHelper {
  ...
  protected static final String CAMUNDA_EJB_CLIENT = "alurkerja.camunda.bpm.javaee:camunda-ejb-client-jakarta";
  protected static final String CAMUNDA_ENGINE_CDI = "alurkerja.camunda.bpm:camunda-engine-cdi-jakarta";
  protected static final String CAMUNDA_ENGINE_SPRING = "alurkerja.camunda.bpm:camunda-engine-spring-6";

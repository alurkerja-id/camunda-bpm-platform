      ...
      JavaArchive[] resolvedArchives = Maven.configureResolver()
          ...
          .addDependencies(
              MavenDependencies.createDependency(engineSpringArtifactName, ScopeType.COMPILE, false,
                  MavenDependencies.createExclusion("alurkerja.camunda.bpm:camunda-engine")),
  ...
  public static JavaArchive[] getSpinJacksonJsonDataFormatForServer(String server) {
    if (server.equals("tomcat") ||
      ...
      return Maven.configureResolver()
          .workOffline()
          .loadPomFromFile("pom.xml")
          .resolve("alurkerja.camunda.spin:camunda-spin-dataformat-json-jackson")
          .using(new RejectDependenciesStrategy(false,
              "alurkerja.camunda.spin:camunda-spin-core",
              "alurkerja.camunda.commons:camunda-commons-logging",
              "alurkerja.camunda.commons:camunda-commons-utils"))
          .as(JavaArchive.class);
    } else {

...
// Spring Boot 4: HibernateJpaAutoConfiguration lives in the optional spring-boot-hibernate module,
// so reference it by name to avoid TypeNotPresentException when JPA is not on the classpath
